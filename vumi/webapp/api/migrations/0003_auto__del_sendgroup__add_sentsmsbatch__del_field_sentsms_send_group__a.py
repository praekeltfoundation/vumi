...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('api_sendgroup', 'api_sentsmsbatch')
        db.rename_column('api_sentsms', 'send_group_id', 'batch_id')    
    
    def backwards(self, orm):
        db.rename_table('api_sentsmsbatch', 'api_sendgroup')
        db.rename_column('api_sentsms', 'batch_id', 'send_group_id')
    ...
    models = {
        ...
        'api.sentsms': {
            ...
            'batch': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['api.SentSMSBatch']", 'null': 'True', 'blank': 'True'}),
            'charset': ('django.db.models.fields.CharField', [], {'default': "'utf8'", 'max_length': '32', 'blank': 'True'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        'api.sentsmsbatch': {
            'Meta': {'ordering': "['-created_at']", 'object_name': 'SentSMSBatch'},
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
