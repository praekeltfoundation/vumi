...
class XmlOverTcpClientTestCase(unittest.TestCase, XmlOverTcpClientServerMixin):
    ...
    def test_packet_parsing_for_wierd_bytes_after_request_id(self):
        ...
        data = self.mk_packet(session_id, body)
    ...
    def test_contiguous_packets_received(self):
        ...
        data = self.mk_packet(session_id_a, body_a)
        data += self.mk_packet(session_id_b, body_b)
        self.client.authenticated = True
        self.server.send_data(data)
    ...
    def test_partial_data_received(self):
        ...
        # second packet
        data = self.mk_packet(session_id_a, body_a)
        data += self.mk_packet(session_id_b, body_b)[:12]
        self.client.authenticated = True
        self.server.send_data(data)
    ...
    def test_authentication(self):
        ...
        request_body = (
            ...
            "</AUTHRequest>"
        % request_id)
        expected_request_packet = self.mk_packet(
        ...
        response_body = (
            ...
            "</AUTHResponse>"
        % request_id)
        response_packet = self.mk_packet(session_id, response_body)
    ...
    def test_unknown_packet_handling(self):
        ...
        request_body = (
            ...
            "</UnknownPacket>"
        % request_id)
        request_packet = self.mk_packet(session_id, request_body)
        ...
        response_body = (
            ...
            "</USSDError>"
        % request_id)
        expected_response_packet = self.mk_packet(
    ...
    def test_data_request_handling(self):
        ...
        packet = self.mk_packet(session_id, body)
        self.client.authenticated = True
    ...
    def test_continuing_session_data_response(self):
        ...
        expected_packet = self.mk_packet(session_id, body)
    ...
    def test_periodic_client_enquire_link(self):
        ...
        request_body_a = (
            ...
            "</ENQRequest>"
        % request_id_a)
        expected_request_packet_a = self.mk_packet(
        ...
        response_body_a = (
            ...
            "</ENQResponse>"
        % request_id_a)
        response_packet_a = self.mk_packet(
        ...
        request_body_b = (
            ...
            "</ENQRequest>"
        % request_id_b)
        expected_request_packet_b = self.mk_packet(
        ...
        response_body_b = (
            ...
            "</ENQResponse>"
        % request_id_b)
        response_packet_b = self.mk_packet(
    ...
    def test_error_response_handling_for_known_codes(self):
        ...
        error_packet = self.mk_packet(session_id, body)
