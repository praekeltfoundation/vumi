...
from vumi.transports.xmpp.tests.test_xmpp_stubs import TestXMPPTransportProtocol
...
class XMPPTransportTestCase(TransportTestCase):
    ...
    def mk_transport(self):
        ...
        test_protocol = TestXMPPTransportProtocol(self.jid, 
    ...
    def test_inbound_message(self):
        ...
        dispatched_messages = self._amqp.get_dispatched('vumi', 'test_xmpp.inbound')
