...
class VumiConsumer(Consumer):
    ...
    menu = MenuSystem(
        case(
            ...
            (returning_user, prompt('Welcome back %(name)s! Continue to see '
                                    'the real-time statistics.', parse=True,
        ...
        case(
            (new_user, prompt('What type of phone do you have?',
                              options=PHONE_OPTIONS, save_as='phone',
                              validator=pick_one)),
            (returning_user, prompt("%(phone_stats)s", parse=True,
        ...
        persist('technology_stats', calculate_stats, 'technology',
                TECHNOLOGY_OPTIONS),
        case(
            (new_user, prompt('Which technology is most suited to your'
                              ' audience?', options=TECHNOLOGY_OPTIONS,
                                save_as='technology', validator=pick_one)),
            (returning_user, prompt("%(technology_stats)s", parse=True,
                                    save_as='continue_or_quit',
                                    options=CONTINUE_OR_QUIT_OPTIONS))
        ),
        case(
        ...
        case(
            (new_user, prompt('What is the most useful application of mobile'
                              ' technology for lower income markets?',
                              options=USEFUL_OPTIONS, save_as='useful',
                              validator=pick_one)),
            (returning_user, prompt("%(useful)s", parse=True,
                                    save_as='continue_or_quit',
                                    options=CONTINUE_OR_QUIT_OPTIONS))
        ),
        case(
