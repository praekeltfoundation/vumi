...
from vumi.workers.cellulant.worker import (XMPPtoCellulantUSSDWorker,
                                           CellulantUSSDtoXMPPWorker,
                                           unpackCellulantUSSDMessage,
                                           packCellulantUSSDMessage)
...
class CellulantTestCase(TestCase):
    ...
    def test_cellulant_conversions(self):
        ...
        self.assertEquals(m1.payload, {'message': 'hello',
                                       'recipient': '*360#',
                                       'sender': '254788111110'})
