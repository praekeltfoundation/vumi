...
class TtcGenericWorker(ApplicationWorker):
    ...
    def schedule_participant_dialogue(self, participant, dialogue):
        ...
        for interaction in dialogue.get('interactions'):
            ...
            if (log is None): #Has the interaction already been send
                ...
                if (interaction['type-schedule']=="immediately"):
                    ...
                    sendingDateTime = datetime(interaction['year'],
                                               interaction['month'],
                                               interaction['day'],
                                               interaction['hour'],
                                               interaction['minute'])
               ...
               #Scheduling a date already in the past is forbidden. 
                ...
                previousSendDateTime = datetime.strptime(log["datetime"],"%Y-%m-%dT%H:%M:%S.%f")
        return schedules
